function trials = trialStruct_LeftRightFullFieldGrating(trialKey)
%TRIALSTRUCT_LEFTRIGHTFULLFIELDGRATING generates trial structure for playing left/right full
%field grating bars in behavior experiemnt.
%Where INPUTS
%   TrialKey: a vector of elements composed of 1 or 2. "1" specifies the grating
%bar is moving to left, and "2" is moving to right.
%OUTPUTS
