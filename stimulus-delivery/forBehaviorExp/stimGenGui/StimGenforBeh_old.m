...
% Last Modified by GUIDE v2.5 18-Oct-2016 14:06:26
...
% set the user of the rig set(handles.userBox,'String',initState.user);
...
% communication like UDP requires the ALL the computers completely get
% ready for sending and recieving data before the first packet. In order to
...
%Call VisGenDefaultTable to supply a default table for this stimulus table
%= StimGenDefaultTable(handles.stimTypeBox); Set the handle to the
...
% hObject    handle to saveTrials (see GCBO) eventdata  reserved - to be
...
% hObject    handle to trialKeysStatus (see GCBO) eventdata  reserved - to
...
% hObject    handle to genTrials (see GCBO) eventdata  reserved - to be
% defined in a future version of MATLAB handles    structure with handles
% and user data (see GUIDATA)
...
% hObject    handle to startstopbutton (see GCBO) eventdata  reserved - to
% be defined in a future version of MATLAB handles    structure with
% handles and user data (see GUIDATA)
...
% hObject    handle to stop (see GCBO) eventdata  reserved - to be defined
...
% hObject    handle to hideCursor (see GCBO) eventdata  reserved - to be
% defined in a future version of MATLAB handles    structure with handles
% and user data (see GUIDATA)
...
% handles.hideCursor = get(hObject,'Value'); if isfield(handles,
% 'screenInfo')
%     handles.screenInfo.hideCursor = handles.hideCursor; if
%     screenInfo.hideCursor
%         HideCursor; handles.screenInfo.KbCheckOn = 1;
%     else
%         ShowCursor; handles.screenInfo.KbCheckOn = 0;
%     end
% end
...
% hObject    handle to Behavior (see GCBO) eventdata  reserved - to be
% defined in a future version of MATLAB handles    structure with handles
% and user data (see GUIDATA)
...
% --- Otherwise, executes on mouse press in 5 pixel border or over stimTypeBox.
function stimTypeBox_ButtonDownFcn(hObject, eventdata, handles)
